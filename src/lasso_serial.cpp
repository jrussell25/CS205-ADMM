...
int main()
{
	...
	Afile.open("data/A0.csv");
	bfile.open("data/b0.csv");
	...
	double lambda = 0.1*xt::linalg::norm(Atb, xt::linalg::normorder::inf);

	std::cout << "Using lambda max heuristic. lambda = " << lambda <<std::endl;
